...
public sealed partial class DoorBoltComponent : Component
{
    ...
    public SoundSpecifier BoltUpSound = new SoundPathSpecifier("/Audio/Machines/MesaStationMachines/button5.ogg");

    /// <summary>
    /// Sound to play when the bolts on the airlock go down.
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadWrite)]
    public SoundSpecifier BoltDownSound = new SoundPathSpecifier("/Audio/Machines/MesaStationMachines/button6.ogg");
